...
public class JadeBotProvider(
    JadeBotRepository repository,
    JadeBotRequest request,
    Gw2ApiGateway gateway,
    StaticMetaRepository staticMetaRepository,
    ILogger? logger = null)
    : Provider<JadeBot, int, JadeBotRepository, JadeBotRequest>(repository, request, gateway, staticMetaRepository,
        logger);
