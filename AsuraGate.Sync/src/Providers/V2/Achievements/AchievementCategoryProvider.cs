...
{
    public AchievementCategoryProvider(AchievementCategoryRepository repository, AchievementCategoryRequest request, Gw2ApiGateway gateway, StaticMetaRepository staticMetaRepository, ILogger? logger = null)
