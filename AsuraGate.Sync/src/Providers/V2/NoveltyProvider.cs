...
{
    public NoveltyProvider(NoveltyRepository repository, NoveltyRequest request, Gw2ApiGateway gateway, StaticMetaRepository staticMetaRepository, ILogger? logger = null)
