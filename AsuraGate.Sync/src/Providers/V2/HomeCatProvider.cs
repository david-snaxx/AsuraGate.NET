...
public class HomeCatProvider(
    HomeCatRepository repository,
    HomeCatRequest request,
    Gw2ApiGateway gateway,
    StaticMetaRepository staticMetaRepository,
    ILogger? logger = null)
    : Provider<HomeCat, int, HomeCatRepository, HomeCatRequest>(repository, request, gateway, staticMetaRepository,
        logger);
