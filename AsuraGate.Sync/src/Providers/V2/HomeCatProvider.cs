...
{
    public HomeCatProvider(HomeCatRepository repository, HomeCatRequest request, Gw2ApiGateway gateway, StaticMetaRepository staticMetaRepository, ILogger? logger = null)
