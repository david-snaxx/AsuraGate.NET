...
{
    public static GuildEntity ToGuildEntity(Models.V2.Guild.Guild guild) => new GuildEntity()
    {
        Id = guild.Id,
        Name = guild.Name,
        Tag = guild.Tag,
    ...
    public static IEnumerable<GuildEmblemFlagEntity> ToEmblemFlagEntities(Models.V2.Guild.Guild guild) =>
        (guild.Emblem?.Flags ?? []).Select(flag => new GuildEmblemFlagEntity() { GuildId = guild.Id, Flag = flag });

    public static IEnumerable<GuildEmblemLayerColorEntity> ToEmblemLayerColorEntities(Models.V2.Guild.Guild guild)
    {
    ...
    public static Models.V2.Guild.Guild ToModel(
        GuildEntity entity,
        ...
        IEnumerable<GuildEmblemLayerColorEntity> emblemLayerColorEntities)
    {
        ...
        return new Models.V2.Guild.Guild()
        {
            Id = entity.Id,
            Name = entity.Name,
            Tag = entity.Tag,
