...
{
    public static AccountEntity ToAccountEntity(Models.V2.Account.Account account) => new AccountEntity()
    {
        Id = account.Id,
        Age = account.Age,
        Name = account.Name,
    ...
    public static IEnumerable<AccountGuildEntity> ToGuildEntities(Models.V2.Account.Account account)
    {
    ...
    public static IEnumerable<AccountAccessEntity> ToAccessEntities(Models.V2.Account.Account account) =>
        account.Access.Select(access => new AccountAccessEntity() { AccountId = account.Id, Access = access });

    public static Models.V2.Account.Account ToModel(
        ...
        IEnumerable<AccountAccessEntity> accessEntities)
    {
        ...
        return new Models.V2.Account.Account()
        {
            Id = entity.Id,
            Age = entity.Age,
            Name = entity.Name,
