...
/// <summary>
/// SQLite table for <see cref="AsuraGate.Spec.Models.V2.Account.AccountWizardsVaultWeekly"/> - a
/// singleton per account (no id on the model), PK is <see cref="AccountId"/> directly.
/// </summary>
[Table("account_wizards_vault_weeklies")]
public class AccountWizardsVaultWeeklyEntity
{
    [PrimaryKey]
    [Column("account_id")]
