...
/// <summary>A single attribute contribution within an <see cref="ItemStatEntity"/> stat set.</summary>
...
public class ItemStatAttributeEntity
{
    ...
    [NotNull, Indexed, Column("item_stat_id")]
    public int ItemStatId { get; set; } // FK to ItemStatEntity

    [NotNull, Indexed, Column("attribute")]
    public string Attribute { get; set; } = string.Empty;

    [NotNull, Column("multiplier")]
